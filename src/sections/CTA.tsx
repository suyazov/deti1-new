...
export function CTA() {
  ...
  return (
    <section id="contact" className="section-dark py-12 md:py-16 xl:py-10 relative overflow-hidden">
      <div className="glow-orb w-[700px] h-[700px] bg-[#00796b]/15 -right-60 bottom-0 animate-pulse-glow" />
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto px-5">
        <div className="blur-reveal text-center mb-6 md:mb-8 xl:mb-5" style={{ transitionDelay: '0.05s' }}>
          ...
          <p className="mt-4 xl:mt-3 text-lg xl:text-base text-[#636e72] max-w-xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="blur-reveal glass-card rounded-[32px] p-5 md:p-8 xl:p-5" style={{ transitionDelay: '0.1s' }}>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-2xl bg-[#00796b]/15 flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 xl:space-y-3">
              ...
              {status === 'success' && (
                <p className="flex items-center justify-center gap-2 text-sm text-[#00796b]">
          ...
          <div className="blur-reveal glass-card rounded-[32px] p-5 md:p-8 xl:p-5 relative overflow-hidden" style={{ transitionDelay: '0.2s' }}>
            ...
            <div className="space-y-4 xl:space-y-3 relative z-10">
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-[#00796b]/15 flex items-center justify-center flex-shrink-0">
                  <MessageCircle className="w-6 h-6 text-[#00796b]" />
                </div>
                <div>
                  <p className="text-sm text-[#636e72]">WhatsApp</p>
                  <p className="text-lg font-semibold text-[#2D3436] group-hover:text-[#00796b] transition-colors">+7 (961) 469-13-33</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-[#2D3436] group-hover:text-[#00796b] transition-colors">@anna_suyazova</p>
                </div>
              </a>

              <div className="glass-card rounded-2xl p-5 flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-black/5 flex items-center justify-center flex-shrink-0">
                  <Mail className="w-6 h-6 text-[#636e72]" />
                </div>
                <div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] bg-[#00796b]/20 rounded-full blur-3xl pointer-events-none hidden lg:block" />
          </div>
        </div>
