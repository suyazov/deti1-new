...
export function FounderWords() {
  return (
    <section className="section-dark py-12 md:py-16 xl:py-10 relative overflow-hidden">
      <div className="glow-orb w-[400px] h-[400px] md:w-[600px] md:h-[600px] bg-[#00b894]/10 -left-40 md:-left-60 top-1/2" />
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-4 sm:px-5">
        ...
        <div className="glass-card rounded-3xl p-6 md:p-10 xl:p-8 relative">
          <Quote className="absolute top-6 left-6 w-10 h-10 md:w-14 md:h-14 text-[#00b894]/20" />
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <div className="grid md:grid-cols-[1fr,260px] gap-6 md:gap-8 items-start mb-6">
              ...
              <div className="mx-auto md:mx-0 w-full max-w-[260px]">
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#00b894]/20 to-[#e73c47]/10 rounded-2xl blur-xl" />
                  <img
                ...
                <div className="mt-3 text-center md:text-left">
                  ...
                  <p className="text-[#2D3436]/50 text-sm">Основатель франшизы</p>
                </div>
              </div>
            </div>

            <div className="rounded-2xl border-l-4 border-[#00b894] bg-black/5 p-5 md:p-6 mb-6">
            ...
            <div className="mt-6 pt-6 border-t border-black/10">
              <p className="text-[#2D3436]/40 text-xs mt-1">С 2015 года в сфере дошкольного развития. Управляю работающими детскими садами, которые открыла с нуля.</p>

              <div className="mt-4">
                <p className="text-xs text-[#2D3436]/40 mb-3">Следите за развитием сети в каналах основателя</p>
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://t.me/suyazovaa"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 glass-card rounded-full px-4 py-2 text-sm text-[#2D3436]/80 hover:bg-[#00b894]/10 hover:border-[#00b894]/30 transition-colors"
                  >
