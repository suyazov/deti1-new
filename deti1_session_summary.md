...
### Что сделано
- Убрано фото детей из Hero.
- H1 и подзаголовок сокращены.
- Bullet-список заменён на 3 яркие цветные карточки:
  - 🚀 Запуск за 2–3 месяца (жёлтая)
  - 📋 Всё готово — CRM, маркетинг, документы, лицензия (фиолетовая)
  - 🤝 Сопровождение основателя Анны Суязовой (голубая)
- Добавлены дудлы по краям.
- Подобраны контрастные цвета карточек.
...
### Что сделано
- H1 изменён на «Дети в приоритете».
- Подзаголовок: «Откройте свой детский сад с поддержкой, методикой и прибылью.»
- Добавлен proof-бейдж: «✔ 420 000 ₽ чистой прибыли в месяц при загрузке 72 ребёнка».
- Убраны бейдж «Франшиза частного детского сада» и 3 цветные карточки.
- Обновлён предрендер в `index.html`.
